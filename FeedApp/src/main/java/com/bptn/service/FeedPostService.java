...
public class FeedPostService {
    ...
    //step1: build the third party API url using the feedpostRequest object parameters entered b the user
    //step2: print logger information once the url is built
    //step3: create a feedResult by calling the getFeedFromNewsApI which gets the first post description 
    //step4: store the feedresult into my post table into my column
